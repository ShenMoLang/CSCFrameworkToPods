...
@interface CSCUserInfo : CSCBaseModel
/*
@property (nonatomic, copy) NSString *name; //姓名
@property (nonatomic, copy) NSString *certificateType; //证件类型：1- 身份证，2-户口本，3-护照，4-军人证，5-回乡证，6-居住证，7-驾照，8-企业代码证，9-经营许可证，A-事业执照，B-事业法人证 ... X-其他，Y-电子邮件，Z-手机号码
@property (nonatomic, copy) NSString *documentNumber; //证件号码
@property (nonatomic, copy) NSString *province; //省份
@property (nonatomic, copy) NSString *city; //城市
@property (nonatomic, copy) NSString *address; //地址
@property (nonatomic, copy) NSString *zipCode; //邮编
@property (nonatomic, copy) NSString *fixedTelephone; //固定电话
@property (nonatomic, copy) NSString *sex; //性别
@property (nonatomic, copy) NSString *birthday; //生日
@property (nonatomic, copy) NSString *maritalStatus; //婚姻状况
@property (nonatomic, copy) NSString *whetherChildren; //有无子女
@property (nonatomic, copy) NSString *occupationType; //职业类型
@property (nonatomic, copy) NSString *individualAnnualIncome; //个人年收入
@property (nonatomic, copy) NSString *familyAnnuakIncome; //家庭年收入
...
//@property (nonatomic, copy) NSString *certificateName; //证件名称
//@property (nonatomic, copy) NSString *certificateDescription; //证照描述
